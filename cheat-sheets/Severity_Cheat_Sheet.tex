...
\texttt{name} {\it expl} \\
\texttt{sev\_name} {\it expl} \\
\texttt{sev\_a} {\it expl} \\
\texttt{sev\_b} {\it expl} \\
\texttt{sev\_mean} {\it expl} \\
\texttt{sev\_cv} {\it expl} \\
\texttt{sev\_loc} {\it expl} \\
\texttt{sev\_scale} {\it expl} \\
\texttt{sev\_xs} {\it expl} \\
\texttt{sev\_ps} {\it expl} \\
\texttt{sev\_wt} {\it expl} \\
\texttt{sev\_lb} {\it expl} \\
\texttt{sev\_ub} {\it expl} \\
\texttt{sev\_conditional} {\it expl} \\

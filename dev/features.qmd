...
| reins reporting trio (`reins_describe` / `reins_stats_df` / `reins_density_df`), incl. Portfolio | a19 | Reporting quartet | `reins`, `book_w_re` |
...
- `reins_describe` — the daily driver: per-stage gross/ceded/net with the same
...
`ClassicalPremium`, the book figures (`fig_4_1` …), `plot_lee`,

...
```
P1 GridDistribution ──┐ ✅ a90–a91   ─► P3 split distributions ─► P4 split portfolio
                      │   (done)         (births shared concerns:  (consumes them; splits into
P2 plots subsystem  ──┘ ✅ a92          _validation / _pricing /    _portfolio_density /
                          (Pass A)      _bucket_window; Agg-only    _sample / _common;

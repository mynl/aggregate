.. code-block:: text
    ...
    //
    // Note ``geometric zt`` is the number-of-trials geometric (support 1, 2,
    // ..., p = 1/n for clause mean n): by memorylessness G | G >= 1 = 1 + G',
    // so zero truncation IS the trials variant. No separate spelling exists (a
    // ``geometric !`` sugar was added at 1.0.0a335 and removed at 1.0.0a336).

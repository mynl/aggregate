...
**aggregate** makes working with aggregate (compound) probability
distributions fast, accurate, easy, and intuitive.  It can solve problems
in insurance, risk management, actuarial science, and related areas, using

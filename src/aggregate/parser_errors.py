...
_TERMINAL_LABELS: dict[str, str] = {
    ...
    "EQUAL_WEIGHT": "'='",
    "RANGE": "':'",
    # DecL keyword terminals (decl.lark). Kept in sync by
    # tests/test_grammar_sync.py — every priority-tagged keyword terminal in
    # the grammar must have a label here.
    "OCCURRENCE": "'occurrence'",
    "AGGREGATE": "'aggregate'",
    "APPROXIMATE": "'approximate' (or 'approx')",
    "BIVARIATE": "'bivariate' (or 'bv')",
    "NETCEDED": "'netceded'",
    "GROSSCEDED": "'grossceded'",
    "GROSSNET": "'grossnet'",
    "CLASH": "'clash'",
    "COPULA": "'copula'",
    "EXPOSURE": "'exposure'",
    "TWEEDIE": "'tweedie'",
    "PREMIUM": "'premium' (or 'prem')",
    "TOWER": "'tower'",
    "MIXED": "'mixed'",
    "PICKS": "'picks'",
    ...
    "FREE": "'free' (zero-rate reinstatement)",
    "NO": "'no' (no reinstatements)",
    "SWING": "'swing' (variable ceded premium)",
    "SLIDE": "'slide' (sliding-scale commission)",
    "RETRO": "'retro' (retrospective rating)",
    "CORRIDOR": "'corridor' (loss-ratio corridor)",
    "BASIC": "'basic' (collar base premium)",
    "LCM": "'lcm' (loss conversion multiplier)",
    "MIN": "'min' (collar floor)",
    "MAX": "'max' (collar cap)",
    "PROFITCOMM": "'pc' (profit commission)",
    "AFTER": "'after' (profit-commission allowance)",
    "LESS": "'less' (premium-minus-loss separator)",
    "DBVSEV": "'dbvsev'",
    "DFREQ": "'dfreq'",
    "DSEV": "'dsev'",
    "DWAIT": "'dwait' (discrete renewal waiting time)",
    "WAIT": "'wait' (renewal waiting time)",
    "YEARS": "'years' (or 'year'; renewal horizon)",
    "SSEV": "'ssev'",
    "LOSS": "'loss'",
    "PAYOFF": "'payoff'",
    "PNL": "'pnl'",
    ...
    "OF": "'of'",
    "TO": "'to'",
    "PART_OF": "'po' (part of, the partial-placement keyword)",
    "ZM": "'zm'",
    "ZT": "'zt'",
    "DISTORTION": "'distortion' (or 'dist')",
